...
public class Pair<X, Y> {
    ...
    public static <A, B> org.benf.cfr.reader.bytecode.analysis.parse.utils.Pair<A, B> make(A a, B b) {
        return new org.benf.cfr.reader.bytecode.analysis.parse.utils.Pair<A, B>(a, b);
    }
